...
import {
    AddProviderRequestModel, ChangeProviderStatusRequestModel, EditProviderGeneralInformationRequestModel, GetProviderByPartnerIdResponseModel,
    GetProviderGamesRequestModel,
    GetProviderGamesResponseModel,
    GetProviderRequestModel,
    GetProviderResponseModel,
    GetProvidersByIdResponseModel,
    ProviderGamesResponseModel, UpdateProviderLogoRequestModel
} from '@/domain/models';
import {
    AddProviderViewModel, ChangeProviderStatusViewModel, EditProviderGeneralInformationViewModel, GetProviderByPartnerIdViewModel, GetProvidersByIdViewModel, GetProvidersViewModel,
    ProviderGamesFilterViewModel,
    ProviderGamesViewModel,
    ProviderGameViewModel,
    ProvidersFiltersViewModel,
    ProvidersViewModel, UpdateProviderLogoViewModel
} from '@/view/models';
